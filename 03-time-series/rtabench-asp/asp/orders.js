...
cflt = { $source: { connectionName: 'cc-kafka', topic: 'orders', "partitionIdleTimeout": { "size": 1, "unit": "second" } } }
order_collection = {$source:{connectionName:'atlas-rtabench', db: "rtabench", coll: "orders"}}
